      ...
      return `
        <section>
          <div class="new-report__header">
            <div class="container">
              <h1 class="new-report__header__title">Ceritakan Pengalaman Kamu Yuk:)</h1>
              <p class="new-report__header__description">
                Silakan lengkapi formulir di bawah untuk membuat cerita baru.<br>
                Jangan boong sama cerita sendiri ya kwwkwk.
              </p>
            </div>
          </div>
        </section>
              ...
              <div class="form-control">
                ...
                <div class="new-form__description__container">
                  <textarea
                    ...
                    name="description"
                    placeholder="Ceritakan apa yang ingin anda ceritakan disini!."
                  ></textarea>
                </div>
              </div>
              <div class="form-control">
    ...
    #setupForm() {
      ...
      this.#form.addEventListener('submit', async (event) => {
        ...
        if (this.#takenDocumentations.length === 0) {
          alert('Mohon ambil atau upload dokumentasi terlebih dahulu!');
          return;
        }
